...
- [想起の設計](concepts/想起の設計.md) — 「記憶」を保存と想起に分けたとき、現代の本質は想起側。本書第二部の概念群を横断する整理
- [まだ言語化できない近さ](concepts/まだ言語化できない近さ.md) — Kozaneba の独自ニッチ。意味関係の明示前の概念間距離
- [分布としての他者](concepts/分布としての他者.md) — ブロードリスニングを狭く取り直した本書での扱い
...
- [Day 15](timeline/Day15.md) — 2026-05-07 / Q1 サブトピック「記憶」「やる気」の再フレーミング、想起の設計 言語化、Q24/Q25 新設
- [Day 16](timeline/Day16.md) — 2026-05-08 / 著者の包括フィードバック ingest（5/7 電車移動中執筆）、Q多数更新、Q8/Q20解決、Q27（Spaced Repetition redesign）新設、まだ言語化できない近さ／分布としての他者 言語化

## 5. 未解決の問い

- [questions/未解決の問い.md](questions/未解決の問い.md) — active な問い 22 件（理論的・編集上・運用上）。Q27 で「Q tracking を Spaced Repetition 系に再設計」が登録済み
- [questions/解決済みの問い.md](questions/解決済みの問い.md) — 解決済みアーカイブ（解決日付き）。現在 Q8・Q14・Q16・Q17・Q20 を保管
...
- `../raw/2026-05-07-nishio-Q4Q5コメント.txt` — 著者が Q4・Q5 に直筆で書き加えたコメントを raw 化（[Q26](questions/未解決の問い.md) 関連、Wiki を AI 生成テキストのみに復元するため移動）。**改変禁止**
- `../raw/2026-05-08-nishio-train-feedback.txt` — Day 16。著者が 5/7 電車移動中に書いた包括フィードバック（Q 一覧・overview への所感・新概念候補・ingest 指示）。**改変禁止**
